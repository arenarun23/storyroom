...
import { adminReassignVideo, adminSetVideoStatus } from "@/app/admin/records/actions";
            ...
            return (
              ...
              >
                ...
                <p className="text-sm font-semibold text-ink">
                  {v.status === "reset"
                    ? "초기화된 기록"
                    : (v.profiles?.display_name ?? (v.owner_id ? "이름 없음" : "탈퇴한 회원"))}
                  {v.profiles?.email && <span className="ml-1 font-normal text-muted">({v.profiles.email})</span>}
                </p>
